...
export const ScaleOptions = [
    ...
    { value: 'Volume_liters', label: 'Volume (liters)' },
    ...
    { value: 'Density_kg_per_m3', label: 'Density (kg/m³)' },
    { value: 'Temperature_C', label: 'Temperature (°C)' },
    { value: 'pH', label: 'pH Level' },
    { value: 'Speed_m_per_s', label: 'Speed (m/s)' },
    { value: 'Time_seconds', label: 'Time (seconds)' },
    { value: 'Frequency_Hz', label: 'Frequency (Hz)' },
    { value: 'Intensity', label: 'Intensity' },
    { value: 'Concentration_mol_per_L', label: 'Concentration (mol/L)' },
    { value: 'Current_A', label: 'Current (Ampere)' },
    { value: 'Pressure_Pascal', label: 'Pressure (Pascal)' },
    { value: 'Energy_Joules', label: 'Energy (Joules)' },
    { value: 'Power_Watt', label: 'Power (Watt)' },
    { value: 'Genetic_Code', label: 'Genetic Code' },
    { value: 'Electromagnetic_Spectrum', label: 'Electromagnetic Spectrum' },
